...
export default function SellerPage() {
  ...
  const handleFinalSubmit = async () => {
    try {
      ...
      const message =
        apiErr.response?.data?.message || "Sotuvda xatolik yuz berdi";
          ...
          <div className="p-6 space-y-4 bg-white">
            <div className="grid gap-1.5">
              ...
              <Input
                ...
                className="rounded-none border-gray-300 focus:ring-primary"
              />
            </div>
            <div className="grid gap-1.5">
            ...
            <Button
              className="w-full h-12 bg-primary hover:bg-primary/90 font-bold rounded-none text-xs uppercase tracking-widest"
              disabled={isSelling}
