            ...
            <Tabs defaultValue="inventory" className="w-full">
                <div className="bg-white p-2 border rounded-sm shadow-sm mb-6">
                    <TabsList className="grid w-full grid-cols-2 sm:w-[400px] h-10 bg-slate-100 p-1">
                        <TabsTrigger value="inventory" className="data-[state=active]:bg-white font-bold text-[11px] uppercase tracking-wider gap-2">
                            <Package size={14} className="text-primary" /> Inventar
                        </TabsTrigger>
                        <TabsTrigger value="returns" className="data-[state=active]:bg-white font-bold text-[11px] uppercase tracking-wider gap-2">
                                ...
                                <Table>
                                    <TableHeader className="bg-slate-50/80">
                                        <TableRow className="hover:bg-transparent">
                                            <TableHead className="text-[10px] font-black uppercase text-slate-500 py-4 px-6">Mahsulot</TableHead>
                                            <TableHead className="text-[10px] font-black uppercase text-slate-500 py-4 px-6">SKU / Kod</TableHead>
                                            <TableHead className="text-[10px] font-black uppercase text-slate-500 py-4 px-6">Kategoriya</TableHead>
                                            <TableHead className="text-[10px] font-black uppercase text-slate-500 py-4 px-6 text-center">Mavjud</TableHead>
                                            <TableHead className="text-[10px] font-black uppercase text-slate-500 py-4 px-6 text-right">Narxi</TableHead>
                                        </TableRow>
                                    </TableHeader>
                                    <TableBody>
                                        ...
                                        <TableRow className="hover:bg-slate-50/50 transition-colors border-b border-slate-100">
                                            <TableCell className="px-6 py-4">
                                                <p className="text-xs font-black uppercase text-slate-800">Iphone 15 Pro Max</p>
                                            </TableCell>
                                            <TableCell className="px-6 py-4">
                                                <code className="text-[10px] font-bold bg-slate-100 px-2 py-1 rounded-sm text-slate-600">IPH-15-PM</code>
                                            </TableCell>
                                            <TableCell className="px-6 py-4">
                                                <Badge variant="secondary" className="text-[9px] font-black uppercase tracking-tighter">Smartfonlar</Badge>
                                            </TableCell>
                                            <TableCell className="px-6 py-4 text-center">
                                                <span className="text-xs font-black text-primary">12 ta</span>
                                            </TableCell>
                ...
                <TabsContent value="returns" className="mt-0 outline-none">
                    <Card className="rounded-sm border-slate-200 shadow-none border-dashed bg-slate-50/50">
                        <CardContent className="h-64 flex flex-col items-center justify-center text-center space-y-4">
                            ...
                            <div>
                                <h3 className="text-sm font-black uppercase text-slate-800 tracking-widest">Zaxirani qaytarib olish</h3>
                            ...
                            <Button variant="outline" disabled className="text-[10px] font-black uppercase">
